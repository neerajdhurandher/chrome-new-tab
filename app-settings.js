import {
    ...
    SHOW_QUOTE_DEFAULT,
    QUOTE_AUTHOR_VISIBILITY_DEFAULT,
...
const DEFAULT_SETTINGS = {
    ...
    [SETTINGS_QUOTE_AUTHOR_VISIBILITY]: QUOTE_AUTHOR_VISIBILITY_DEFAULT,
    [SETTINGS_SHOW_QUOTE]: SHOW_QUOTE_DEFAULT
};
...
export async function initAppSettings() {
    ...
    await Promise.all([
        ...
        ensureSetting(SETTINGS_QUOTE_AUTHOR_VISIBILITY),
        ensureSetting(SETTINGS_SHOW_QUOTE)
    ]);
